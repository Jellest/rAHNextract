...
#'@param filtered Default FALSE. Only applicable for AHN1 or AHN2 point cloud data. It decides if you want to download the 'gefiltered' point cloud data set or the 'uitgefiltered'.
...
ahn_area <- function(name, X, Y, radius, bbox, polygon, LONLAT = FALSE, type = "raster", AHN = "AHN3", dem = "dsm", resolution, interpolate = TRUE, filtered = FALSE, decimals = 2, sheets = FALSE, delete.sheets = FALSE, redownload = FALSE){
